...
export async function POST(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
        success: true,
        message: `Deployment started successfully. You can access the deployed website at ${domain}/${projectId}/index.html in a few minutes`,
        deployedLink: `${domain}/${projectId}/index.html`,
